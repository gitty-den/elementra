...
const CREATURES_DATA = {
  ...
  "creatures": [
    ...
    },
    {
      ...
      "passive": "kraken_passive",
      "active": "kraken_active",
      "unique": true,
      "mvp": false
    },
    {
      ...
      "passive": "moloch_passive",
      "active": "moloch_active",
      "unique": true,
      "mvp": false
    }
  ]
...
// Runde 12 (22.07.2026): Fusion war â€žzu leicht" (Nutzer). Gate von Level 3 auf
// MAX_LEVEL angehoben â€” beide Zutaten mÃ¼ssen voll ausgebaut sein. Das Ergebnis
...
// bewusstes End-Ziel, kein FrÃ¼hspiel-SelbstlÃ¤ufer. Fusionen liegen ohnehin
// NICHT im Balancing-Pool der Kampagne (tools/campaign.mjs) â€” sie sind optionale
